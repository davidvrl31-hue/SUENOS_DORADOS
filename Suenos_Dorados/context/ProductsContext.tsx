...
import { API, Categoria, Producto, VarianteProducto, Color, Medida } from "../services/api.service";
    ...
    try {
      ...
      const mapped: ProductoUI[] = prods
        ...
        .map((p) => {
          ...
          const varsProd = vars.filter((v) => v.idProducto === p.idProducto && v.estado && v.stock > 0);
